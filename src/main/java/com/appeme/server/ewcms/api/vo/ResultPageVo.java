...
public class ResultPageVo<T> extends ResultVo<Collection<T>> {
    ...
    public static <T> ResultPageVo<T> of(Page<T> pageEntity, Integer page, Integer size){
        return new ResultPageVo<>(page, size, pageEntity.getTotalElements(), pageEntity.getContent());
    }
